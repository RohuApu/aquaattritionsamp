...
def main():
    ...
    if flask.request.method == 'POST':
        ...
        data.AMBASSADOR.replace(to_replace = {'0':0,'5S':1,'EMS':2,'VISION':3,'BEST OPERATOR':4,'CANTEEN COMMITTEE MEMBER':5,'RFT AMMABASSADOR':6,'WORKS COMMITTEE MEMBER':7}, inplace = True)
